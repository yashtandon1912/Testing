...
class ThreadController extends Controller
{
     ...
     * If creation is successfu            'verbs' => [
l, the browser will be redirected to the 'view' page.
     * @return mixed
     */
     ...
     * If update is successful, the brows            'verbs' => [
er will be redirected to the 'view' page.
     * @param integer $id
     * @return mixed
     * @throws NotFoundHttpException if the model cannot be found
     */
